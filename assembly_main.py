...
def generate_assembly():
    ...
    components = [
        {"name": "Spool Right", "file": "part_01_spool_right.step", "pos": App.Placement(), "mod": "part_01_spool_right", "func": "build_right_spool"},
        {"name": "Spool Left", "file": "part_01_spool_left.step", "pos": App.Placement(), "mod": "part_01_spool_left", "func": "build_left_spool"},
        {"name": "Handle", "file": "part_02_handle.step", "pos": App.Placement(), "mod": "part_02_handle", "func": "build_handle"},
        {"name": "Frame Right", "file": "part_03_frame.step", "pos": App.Placement(App.Vector(0,0,z_R), App.Rotation()), "mod": "part_03_frame", "func": "build_frame_export"},
        {"name": "Frame Left", "file": "part_03_frame.step", "pos": App.Placement(App.Vector(0,0,-z_R), App.Rotation(App.Vector(0,1,0), 180)), "mod": "part_03_frame", "func": "build_frame_export"},
        ...
        {"name": "Frame Bolt R3", "file": "part_04_fasteners.step", "pos": App.Placement(App.Vector(0, y_top, z_right_outer), bolt_rot_R), "mod": "part_04_fasteners", "func": "build_fastener"},
        # Left Fasteners
        {"name": "Frame Bolt L1", "file": "part_04_fasteners.step", "pos": App.Placement(App.Vector(x_spread, y_floor, z_left_outer), bolt_rot_L), "mod": "part_04_fasteners", "func": "build_fastener"},
        {"name": "Frame Bolt L2", "file": "part_04_fasteners.step", "pos": App.Placement(App.Vector(-x_spread, y_floor, z_left_outer), bolt_rot_L), "mod": "part_04_fasteners", "func": "build_fastener"},
        {"name": "Frame Bolt L3", "file": "part_04_fasteners.step", "pos": App.Placement(App.Vector(0, y_top, z_left_outer), bolt_rot_L), "mod": "part_04_fasteners", "func": "build_fastener"}
    ]
    ...
    for comp in components:
        ...
        if not os.path.exists(filepath):
            ...
            if comp.get("mod") and comp.get("func"):
                mod = importlib.import_module(comp["mod"])
                gen_func = getattr(mod, comp["func"])
                gen_func()
            else:
                print(f"Warning: No generation mapping for {comp['file']}")
