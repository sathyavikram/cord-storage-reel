...
def build():
    try:
        ...
        print("cap_cutter shape:", cap_cutter.Volume, cap_cutter.isValid())
        
        l_pin_bearing_cut = l_pin_bearing.cut(cap_cutter)
        print("l_pin_bearing cut volume:", l_pin_bearing_cut.Volume, l_pin_bearing_cut.isValid())
        
        l_pin_bearing_cut = l_pin_bearing_cut.removeSplitter()
        print("l_pin_bearing cut removeSplitter volume:", l_pin_bearing_cut.Volume, l_pin_bearing_cut.isValid())
